...
resume_from = None
load_from = f"{root}/checkpoints/pixart_20x_512_sd3_vae_pos_embed/checkpoints/last.pth"
ignore_keys = ["y_embedder.y_embedding", "y_pos_embed"]
...
work_dir = f"{root}/checkpoints/pixart_20x_1024_sd3_vae_pos_embed"
